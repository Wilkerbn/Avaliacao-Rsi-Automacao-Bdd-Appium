...
Esquema do Cenário: Deve inserir uma conta 
    ...
    Então devo receber a informacao "<informacaoEsperada>"
    
Exemplos: 
      | apelidoUsuario       | email                         | senha     | confirmaSenha  |  nome       | ultimoNome  | telefone    | pais     |  estado         | endereco          | cidade      | cep       | informacaoEsperada       |
      | Wilke0003            | wilker.bn@hotmail.com         | Wbn000001 | Wbn000001      |  Wilker     |	Nogueira	  | 11911111111 | Brazil   |  SP             | R. Autonomistas 1 | Osasco      | 11111-111 | Wilke0003          			|
